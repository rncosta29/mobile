...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean error, login = false;
    ...
    private void validarLogin() {
        ...
        if (agencia.getText().toString().equals("")  || conta.getText().toString().equals("") || senha.getText().toString().equals("")) {
            toastErro();
        } else {
    ...
    public void showToast() {
        ...
        String texto = "Sua informações estão incorretas";
